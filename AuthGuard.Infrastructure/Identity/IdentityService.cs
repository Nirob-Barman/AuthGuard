...
//        public IdentityService(UserManager<Entity.ApplicationUser> userManager, SignInManager<Entity.ApplicationUser> signInManager, RoleManager<IdentityRole> roleManager, IJwtTokenService jwtTokenService, ApplicationDbContext context, IEmailService emailService, IHttpContextAccessor httpContextAccessor, IUnitOfWork unitOfWork)
//        {
...
//                //var welcomeMessage = $"Hello {request.FullName},<br>Welcome to AuthGuard! Thank you for registering.";
//                //await _emailService.SendEmailAsync(user.Email!, "Welcome to AuthGuard", welcomeMessage);
...
//                var response = new RegisterResponse(user.Email!, user.FullName!, request.Role);
...
//        public async Task<(bool Success, JwtUserInfo? UserInfo, IList<string> Roles, List<string> Errors)> ValidateCredentialsAsync(string email, string password)
//        {
...
//                return (false, null, new List<string>(), errors);
//            }
...
//            return (true, userInfo, roles, errors);
//        }
...
//            if (user == null)
//                //return ApiResponse<UserProfileResponse>.NotFoundResponse("User not found.");
//                return Result<UserProfileResponse>.Fail("User not found",new List<string> { "User ID is required." });
...
//        private async Task<AuthResponse> GenerateTokensAsync(Entity.ApplicationUser user)
//        {
//            var roles = await _userManager.GetRolesAsync(user);
...
//        public async Task<Entity.ApplicationUser> CreateUserAsync(RegisterRequest request)
//        {
//            var user = new Entity.ApplicationUser
//            {
//                Email = request.Email,
...
//        public async Task<Entity.ApplicationUser?> FindByEmailAsync(string email)
//        {
...
//        private async Task<Entity.ApplicationUser?> FindUserByIdAsync(string userId)
//        {
...
//        public async Task<bool> CheckPasswordAsync(Entity.ApplicationUser user, string password) 
